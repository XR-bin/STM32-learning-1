...
/*************************** FSMC 驱 动 LCD ******************************/
  //地址的偏离多少取决于数据类型
  //u8   偏移0x1   u16  偏移0x2     u32  偏移0x4
  typedef struct
  {                   //基础地址      0x6c00 0000
    vu16 LCD_CMD;     //命令数据地址  0x6c00 07ee   地址偏移0x00
    vu16 LCD_DAT;     //参数数据地址  0x6c00 0800   地址偏移0x02
  }LCD_TypeDef;
...
*********************************************************************/
  //定义方法1(宏定义方法)
  #define  LCD_CMD1     (*(vu16 *)((u32)0x6c000000))
  #define  LCD_DAT1     (*(vu16 *)((u32)0x6c000800))
...
*********************************************************************/
  //定义方法2(结构体方法)
  #define LCD_BASE  ((u32)0x6c0007fe)   //基础地址
