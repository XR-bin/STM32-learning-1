...
THIS:  
    ...
    */
    tp_dev.xfac = ((float)(lcddev.width-20) - 20.0f) / (touch_xy[3].x - touch_xy[0].x);
    tp_dev.xfac += (20.0f - (float)(lcddev.width-20)) / (touch_xy[2].x - touch_xy[1].x);
    tp_dev.xfac /= 2;
    tp_dev.yfac = ((float)(lcddev.height-20) - 20.0f) / (touch_xy[3].y - touch_xy[0].y);
    tp_dev.yfac += ((float)(lcddev.height-20) - 20.0f) / (touch_xy[2].y - touch_xy[1].y);
    tp_dev.yfac /= 2;
