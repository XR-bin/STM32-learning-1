...
/*************************** FSMC 驱 动 LCD ******************************/
  ...
  typedef struct
  {                   //基础地址      0x6c00 0000
    vu16 LCD_CMD;     //命令数据地址  0x6c00 007e   地址偏移0x00
    vu16 LCD_DAT;     //参数数据地址  0x6c00 0080   地址偏移0x02
  }LCD_TypeDef;
...
*********************************************************************/
  ...
  #define  LCD_DAT1     (*(vu16 *)((u32)0x6c000080))
...
*********************************************************************/
  //定义方法2(结构体方法)
  #define LCD_BASE  ((u32)0x6c00007e)   //基础地址
